...
GET /objects returns a preconfigured device list and does not reflect newly created devices    
Payload validation is minimal. Invalid or empty payloads are accepted  
